  ...
  return (
    <header className='flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between'>
      <div className='min-w-0'>
        {eyebrow && <p className='text-xs font-extrabold uppercase tracking-[0.12em] text-[#263b5c]'>{eyebrow}</p>}
        <h1 className='mt-1 text-[28px] font-extrabold tracking-tight text-slate-950 md:text-[32px]'>{title}</h1>
        <p className='mt-1 max-w-3xl text-sm font-medium leading-relaxed text-slate-600'>{description}</p>
      </div>
