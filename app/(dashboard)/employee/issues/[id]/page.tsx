      ...
      <div className='employee-material-shell relative mx-auto min-h-screen w-full max-w-[520px] shadow-2xl md:min-h-[calc(100vh-3rem)] md:overflow-hidden md:rounded-[28px]'>
        ...
        <div className='px-4 pb-5 pt-2'>
          ...
          {showConversation && !isCreditIssue && <Card className='employee-material-form mt-4'>
            <div className='mb-4 flex items-center gap-2'><span className='employee-material-heading-icon'><PremiumChatIcon color='#278f18' secondaryColor='#b7e9ac' secondaryOpacity={1} className='h-7 w-7' /></span><h2 className='text-lg font-extrabold'>Сообщение администратору</h2></div>
