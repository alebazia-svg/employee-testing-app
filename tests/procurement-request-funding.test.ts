...
import { assessProcurementRequests, type FundingPlan } from "../lib/procurement-request-funding";

const base = { asOf: "2026-09-15", salary: { dueOn: "2026-09-16", amountMinor: 50_000_000 }, rent: { dueOn: "2026-09-20", amountMinor: 23_500_000 }, safeMinor: 60_000_000, cardsMinor: 30_000_000, bankAccountsMinor: 100_000_000, vtbCardMinor: 20_000_000, vtbAccountMinor: 40_000_000, tbankCardMinor: 10_000_000, tbankAccountMinor: 60_000_000, tbankTransferStatus: "verified" as const, tbankCurrentRateBps: 100, tbankCurrentTierRemainingMinor: 80_000_000, usdtBalance: 5_000, accountableBalanceMinor: 20_000_000, usdtRate: 89 };
